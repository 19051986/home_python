...
def my_func_new(num_1, num_2, num_3):
    """С помощью функции sort уменьшается время обработки"""
    my_string = [num_1, num_2, num_3]
    my_string.sort()
...
"""Вывод с помощью функции f в одну строку уменьшает время обработки"""
...
print(timeit("my_function('5')", globals=globals(), number=1000))
print(timeit("my_function_2('5')", globals=globals(), number=1000))
...
print(timeit("my_func_2()", globals=globals(), number=1000))
