...
# целые числа, начиная с 3, а при достижении числа 10 завершаем цикл. Во втором
# также необходимо предусмотреть условие, при котором повторение элементов
# списка будет прекращено.

from itertools import cycle, count

v_start = int(input('Начальное число: '))
